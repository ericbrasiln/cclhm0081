---
title: "Conteúdo — Aula 6: Independências da América Hispânica"
...
qmd: "index.qmd"
html: "index.html"
fonte_legada: "slides/aula-6/index.qmd (material legado; 2026.1)"
ponto_de_corte: "Aula 6 completa do legado; próxima aula: Formação dos Estados Nacionais da América Latina (01/10/2026)"
---

# Conteúdo da Aula 6

> **Arquivo editorial de revisão.** Enquanto o campo `status` estiver como `em revisão`, o `index.qmd` não deve ser atualizado. O `index.html` é uma prévia standalone derivada desta fonte editorial.

> **Base desta versão:** conteúdo legado de `slides/aula-6/index.qmd`, reendereçado para a Aula 6 de 24 de setembro de 2026. Os textos, a ordem e as notas docentes foram preservados; a abertura de título é uma composição editorial.

## Slide 1 — Título

## Independências da América Hispânica
...
## Slide 4 — # Os dois textos da aula
...
## Slide 5 — Parte I — A crise do Império espanhol

# Parte I — A crise do Império espanhol

---

## Slide 6 — # Transformações (séc. XVII–XIX)
...
## Slide 8 — # 1808: a crise dinástica
...
## Slide 9 — # Constituição de Cádiz (1812)
...
## Slide 10 — # Impactos nas colônias
...
**Nota de preservação:** o QMD legado em `slides/aula-6/index.qmd` não foi alterado. A sincronização com o `index.qmd` da Aula 6 depende da aprovação desta revisão.
