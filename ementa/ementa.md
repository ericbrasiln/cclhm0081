...
::: {.callout-warning}
O conteúdo programático, assim como cronograma e leituras previstas, estão em atualização. Vamos fechar todas as informações até o início do semestre, mas já disponibilizamos as informações iniciais para que as/os estudantes possam se organizar. Fiquem atentos às atualizações.
:::
...
- Analisar a participação de escravizados, libertos e negros livres na luta por independência de Cuba;
